...
namespace QuanLyCuaHangPho.Models
{
    class connection
    {
        public static string sqlcon = @"Data Source=HUNG\SQLEXPRESS;Initial Catalog=Quanliquanpho;Integrated Security=True";
        ...
        public static Int32 Excute_SqlReturn(string strQuery, CommandType cmdtype, string[] para, object[] values)
        {
            SqlConnection conn = new SqlConnection();
            conn = Getconnection();
            conn.Open();
            ...
            conn.Close();
            Int32 k;
            k = Convert.ToInt32(sqlcmd.Parameters["return"].Value);
            return k;
        }
